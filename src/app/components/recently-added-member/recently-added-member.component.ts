...
@Component({
  selector: 'app-recently-added-member',
  templateUrl: './recently-added-member.component.html',
  styleUrls: ['./recently-added-member.component.css']
})
export class RecentlyAddedMemberComponent implements OnInit {
 ...
 getRecentlyadded(): void {
   this.registerServiceService.getRecentlyadded()
      .subscribe(result => {
        ...
        _.remove(this.recentlyAdded, item => {
